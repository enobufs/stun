 ...
 * @static
 */
Client._isLocalAddr = function (addr) {
...
Client.prototype._onTick = function () {
    ...
    console.log('tick (%d)', this._elapsed);
...
Client.prototype.start = function (option, cb) {
    ...
    if (this._domain == undefined && this._serv0 == undefined)
    ...
    if (this._serv0 == undefined) {
        dns.resolve4(this._domain, this._onResolved);
...
Client.prototype.isNatted = function () {
    ...
    if (this._local.addr == '0.0.0.0') {
        return !Ctor._isLocalAddr(this._mapped[0].addr);
    }

    return (this._mapped[0].addr)? (this._mapped[0].addr != this._local.addr):undefined;
};
...
Client.prototype.getEF = function () {
    ...
    if (this._ef.ad == undefined) {
        console.log("this._ef.ad was undefined");
        return Const.Type.UNDEF;
    }

    if (this._ef.pd == undefined) {
        console.log("this._ef.pd was undefined");
        return Const.Type.UNDEF;
    }
